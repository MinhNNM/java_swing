...
public class view extends javax.swing.JFrame {
     ...
     */
    DefaultTableModel tmKH, tmDV, tmHD;
    String fKH, fDV, fHD;
    List<KhachHang> lKH;
    List<DichVu> lDV;
    List<HoaDOn> lHD;
    public view() {
        ...
        String[] kh={"ma KH", "Ho ten", "Dia chi", "Loai KH"};
        String[] dv={"ma DV", "Ten Dv", "Gia cuoc", "Don vi tinh"};
        String[] hd={"Ma KH", "Ma DV", "Ho ten", "Ten DV", "So luong"};
    ...
    private boolean trungma(int mKH, int mDV){
        for(HoaDOn i:lHD){
            if(i.getKh().getMa()==mKH && i.getDv().getMa()==mDV)
                return true;
        }
        return false;
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Thong Tin KH", jPanel1);
        ...
        jTabbedPane1.addTab("Thong tin dich vu", jPanel2);
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Lua chon sap xep---", "Sap xep theo ten KH", "Sap xep theo so luong su dung" }));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        jTextField4.setText(DichVu.getSma()+"");
        String ten;
        double giacuoc;
        String donvi;
        try {
            ten=jTextField5.getText();
            giacuoc=Double.parseDouble(jTextField6.getText().toString());
            donvi=jTextField7.getText();
            DichVu dv=new DichVu(ten, giacuoc, donvi);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(row>=0 && row<jTable2.getRowCount()){
            ...
            double giacuoc=Double.parseDouble(jTextField6.getText().toString());
            String donvi=jTextField7.getText();
            tmDV.setValueAt(ma, row, 0);
            tmDV.setValueAt(ten, row, 1);
            tmDV.setValueAt(giacuoc, row, 2);
            tmDV.setValueAt(donvi, row, 3);
            DichVu dv=new DichVu(ma, ten, giacuoc, donvi);
            lDV.set(row, dv);
        }else{
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        // TODO add your handling code here:
        int row=jTable2.getSelectedRow();
        jTextField4.setText(tmDV.getValueAt(row, 0).toString());
        jTextField5.setText(tmDV.getValueAt(row, 1).toString());
        jTextField6.setText(tmDV.getValueAt(row, 2).toString());
        jTextField7.setText(tmDV.getValueAt(row, 3).toString());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        int mDV=Integer.parseInt(jComboBox3.getSelectedItem().toString());
        if(trungma(mKH, mDV)){
        ...
        int soluong;
        try {
            soluong=Integer.parseInt(jTextField8.getText().toString());
            HoaDOn hd=new HoaDOn(getKH(mKH), getDV(mDV), soluong);
